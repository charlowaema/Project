...
<label for="Loans">comprehensive statement</label>
<input type="radio" id="transactionType" name="statementType" value="loans" required checked>
<br>
</span>
&nbsp&nbsp
<span style="white-space:nowrap">
<label for="savings">Statement By Range Date</label>
<input type="radio" id="transactionType" name="statementType" value="savings" required><input type="text" name="userId" id="userId">To<input type="text" name="userId" id="userId">

</span>
<br>
<button type="submit" name="searchbutton" class="btn btn-primary" style="background:red"  ><span class="glyphicon glyphicon-search" aria-hidden="true" ></span>&nbsp;View Statement</button>

</form>
<div class="form-group" align="center"><input type="submit" name="postItem" value="post" class="btn btn-primary"></div>